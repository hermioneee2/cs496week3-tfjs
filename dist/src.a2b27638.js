...
var btnStart = document.getElementById("btnStart"); // btnStart.addEventListener("click", function () {
...
socket.on("appConnected", () => {
  document.getElementById("appConnected").innerHTML = "App is now connected. Do you want to start game?";
  btnStart.style.display = "block"; // window.location.href = "./main.html";
});
